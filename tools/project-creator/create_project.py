...
# Author: WangZhe
# Modification: zrong(zengrong.net) 2013-09-12
...
cocos2dxhome = os.environ.get("COCOS2DX_HOME")
if (cocos2dxhome == None):
    print "Please set the COCOS2DX_HOME enviroment!"
    sys.exit()
print "the COCOS2DX_HOME Enviroment is: " + cocos2dxhome

def dumpUsage():
    print "Usage: create_project.py -project PROJECT_NAME -package PACKAGE_NAME -language PROGRAMING_LANGUAGE -path d:/works/projects/"
    print "Options:"
    ...
    print "  -path  PROJECT_PATH The directory that project will create in, should be [ d:/works/projects/ | /home/zrong/projects/ ]"
    print ""
    print "Sample 1: ./create_project.py -project MyGame -package com.MyCompany.AwesomeGame"
    print "Sample 2: ./create_project.py -project MyGame -package com.MyCompany.AwesomeGame -language javascript -path d:/works/projects/"
    print ""
...
def processPlatformProjects(platform):
    ...
    for i in range(0, len(data["replace_project_name"])):
        ...
        if (os.path.exists(proj_path + dst) == True):
            ...
            # replace the cocos2dx_home enviroment
            # some config file do not support the enviroment variables, so it must use the absolute path
            replaceString(proj_path + dst, "@COCOS2DX_HOME@", cocos2dxhome)
    # done!
